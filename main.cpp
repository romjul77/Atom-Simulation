...
void display()
{
    ...
    if (value == -1)
    {
        char cn[] = "BANGALORE INSTITUTE OF TECHNOLOGY";
        drawhead(-490, 900, 0, cn);
        char pn[] = "K. R. Road, V. V. Puram, Bengaluru-560 004";
        ...
        char g1[] = "Dr Gunavathi H.S.";
        drawhead(290, -250, 0, g1);
        char d1[] = "Assistant Professor, Dept. Of CSE, BIT";
        drawsubhead(290, -300, 0, d1);

        char g2[] = "Prof. N. Thanuja";
        drawhead(290, -400, 0, g2);
        char d2[] = "Assistant Professor, Dept. of CSE, BIT";
    ...
    if (value != -1)
    {
        ...
        drawString(-225, -30, 0, d);
         char x1[] = "The nucleus is the central part of an atom that contains protons and neutrons.";
        drawString(-500, -500, 0, x1);
    ...
    if (value == 1)
    {
        ...
        char x2[] = "Hydrogen is the lightest and most abundant element in the universe";
        drawString(-500, -600, 0, x2);
        circle(400);
        char o[] = "ORBIT";
        drawString(410, 10, 0, o);
        glPushMatrix();
    ...
    if (value == 2)
    {
        char n[] = "HELIUM";
        drawhead(-100, 900, 0, n);
        char x3[] = " A noble gas with two protons and two electrons, used in balloons and cryogenics.";
        drawString(-500, -600, 0, x3);
    ...
    if (value == 3)
    {
        char n[] = "LITHIUM";
        drawhead(-100, 900, 0, n);
        char x4[] = "A soft, silvery-white metal that reacts strongly with water and has three protons in its nucleus.";
        drawString(-500, -650, 0, x4);
        circle(400);
        circle(600);
        char o[] = "ORBIT";
    ...
    if (value == 4)
    {
        char n[] = "BERYLLIUM";
        drawhead(-100, 900, 0, n);
        char x5[] = "A hard, brittle alkaline earth metal with four protons, used in high-strength alloys.";
        drawString(-500, -650, 0, x5);
        circle(400);
        circle(600);
        char o[] = "ORBIT";
        drawString(610, 0, 0, o);
    ...
    if (value == 5)
    {
        char n[] = "BORON";
        drawhead(-100, 900, 0, n);
        char x6[] = "A metalloid element,known for its use in semiconductor materials.";
        drawString(-500, -650, 0, x6);
        circle(400);
        circle(600);
        char o[] = "ORBIT";
        drawString(610, 0, 0, o);
    ...
    if (value == 6)
    {
        char n[] = "CARBON";
        drawhead(-100, 900, 0, n);
         char x7[] = "The key element in organic chemistry, with a variety of allotropes.";
        drawString(-500, -650, 0, x7);
        circle(400);
        circle(600);
        char o[] = "ORBIT";
        drawString(610, 0, 0, o);
    ...
    if (value == 7)
    {
        char n[] = "NITROGEN";
        drawhead(-100, 900, 0, n);
        char x8[] = "A colorless, odorless gas, constituting approximately 78% of Earth's atmosphere.";
        drawString(-500, -650, 0, x8);
        circle(400);
        circle(600);
        char o[] = "ORBIT";
        drawString(610, 0, 0, o);
    ...
    if (value == 8)
    {
        char n[] = "OXYGEN";
        drawhead(-100, 900, 0, n);
        char x9[] = " A reactive gas, comprising about 21% of the atmosphere.";
        drawString(-500, -650, 0, x9);
        circle(400);
        circle(600);
        char o[] = "ORBIT";
        drawString(610, 0, 0, o);
    ...
    if (value == 9)
    {
        char n[] = "FLUORINE";
        drawhead(-100, 900, 0, n);
        char x10[] = "A highly reactive halogen gas, used as a component of fluoride compounds";
        drawString(-500, -650, 0, x10);
        circle(400);
        circle(600);
        char o[] = "ORBIT";
        drawString(610, 0, 0, o);
    ...
    if (value == 10)
    {
        char n[] = "NEON";
        drawhead(-100, 900, 0, n);
        char x11[] = "A noble gas, commonly used in lighting.";
        drawString(-500, -650, 0, x11);
        circle(400);
        circle(600);
        char o[] = "ORBIT";
        drawString(610, 0, 0, o);
